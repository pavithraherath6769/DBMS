  ...
  return (
    <nav className="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <Link className="navbar-brand brand-logo" to="/console/dashboard"><img src={logo} alt="logo" /></Link>
        <Link className="navbar-brand brand-logo-mini" to="/console/dashboard"><img src={logo_mini} alt="logo" /></Link>
      </div>
      <div className="navbar-menu-wrapper d-flex align-items-stretch">
        ...
        <ul className="navbar-nav navbar-nav-right">            
          <li className="nav-item">
            <Dropdown alignRight>
              <Dropdown.Toggle className="nav-link count-indicator" style={{cursor:"not-allowed"}}>
            ...
            <Dropdown alignRight>
              <Dropdown.Toggle className="nav-link">
                ...
                <div className="nav-profile-text">
                  <p className="mb-1 text-black"><Trans>{props.user}</Trans></p>
                </div>
              </Dropdown.Toggle>

              <Dropdown.Menu className="navbar-dropdown">                  
                <Dropdown.Item href="!#" onClick={() =>history.push({pathname: "/"})}>
